...
console.log(
  ...
  `     Then translate it: src/layer2_docker/${slug}/i18n.ja.json holds`,
  '     the Japanese for every data-i18n key in that file. Both are',
  '     tracked; index.ja.html is generated by `mise run repro:i18n`.',
);
console.log(
