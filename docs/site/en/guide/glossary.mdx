...
<Page>
  ...
  >
    <dl className="v-glossary">
      ...
      <dd>
        The output of running a recipe — either <code>"reproduced"</code>
        or <code>"unreproduced"</code>. <strong>Reproduced means the
        upstream bug reproduces.</strong> Unreproduced means it does
        not. The values were originally <code>"pass"</code> /
        <code>"fail"</code>; renamed in Contract v1 Revision 3
        (ADR-0029) so the literal name now matches its meaning.
        See <a href="/spec/contract-v1#verdict-semantics">verdict
        semantics</a>.
      </dd>
      ...
      <dd>
        ...
        page; Layer 2 / 3 ship it inside <code>verdict.json</code>. Contract
        v1 rev 2 makes the comparison page show <em>why</em>, not just
        <em>whether</em>.
      </dd>
    </dl>
  </Section>
  ...
  >
    <dl className="v-glossary">
      ...
      <dd>
        ...
        declare its own Vivarium-runnable reproduction. v1 is stable; see
        <a href="/spec/manifest-v1">Manifest v1</a>. A manifest
  ...
  >
    <dl className="v-glossary">
      ...
      <dd>
        ...
        verdict flips from <code>reproduced</code> to
        <code>unreproduced</code>, the fix is doing its job. See
      ...
      <dd>
        ...
        does it just look right?" The walkthrough wires the branch-fix
        pipeline + comparison page + MCP tools into one flow.
      </dd>
      ...
      <dd>
        ...
        verdict for its own manifest's reproduction.
      </dd>
    </dl>
  </Section>
...
<NextCta
  ...
  ghost={{ label: 'Overview', href: '/overview' }}
/>
